        ...
        {legs.map((leg, index) => (
          ...
          >
            ...
            <div className="p-4 flex flex-col gap-4">
              {/* Photo + Description (for destinations, not hotel steps) */}
              {leg.image && leg.description && (
                ...
                <div className="flex flex-col gap-2">
                  {leg.tips.map((tip, i) => (
                    ...
                    >
                      ...
                      <div>
                        <span className={cn("text-xs font-sans font-bold uppercase tracking-wide mr-1.5", tipConfig[tip.type].iconColor)}>
                          {tipConfig[tip.type].label}:
                        </span>
                        <span className={cn("text-sm leading-snug", tipConfig[tip.type].text)}>
                          {tip.text}
                        </span>
                      </div>
                    </div>
              ...
              {/* Maps buttons */}
              <MapsButton destination={leg.mapsDestination ?? leg.to} />
            </div>
          </div>
        ))}
      </div>
